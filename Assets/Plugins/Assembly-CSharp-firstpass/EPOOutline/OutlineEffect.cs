...
namespace EPOOutline
{
	public static class OutlineEffect
	{
		...
		private static void SetupCutout(OutlineParameters parameters, OutlineTarget target)
		{
			...
			Vector4 value = new Vector4(((target.CutoutMask & ColorMask.R) != 0) ? 1f : 0f, ((target.CutoutMask & ColorMask.G) != 0) ? 1f : 0f, ((target.CutoutMask & ColorMask.B) != 0) ? 1f : 0f, ((target.CutoutMask & ColorMask.A) != 0) ? 1f : 0f);
