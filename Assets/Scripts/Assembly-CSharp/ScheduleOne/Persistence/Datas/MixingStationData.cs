...
namespace ScheduleOne.Persistence.Datas
{
	public class MixingStationData : GridItemData
	{
		...
		public MixingStationData(Guid guid, ItemInstance item, int loadOrder, ScheduleOne.Tiles.Grid grid, Vector2 originCoordinate, int rotation, ItemSet productContents, ItemSet mixerContents, ItemSet outputContents, MixOperation currentMixOperation, int currentMixTime)
