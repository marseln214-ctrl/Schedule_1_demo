...
namespace ScheduleOne.PlayerScripts
{
	public class PlayerCrimeData : NetworkBehaviour
	{
		...
		public EPursuitLevel CurrentPursuitLevel
		{
			...
			get
			{
				return _003CCurrentPursuitLevel_003Ek__BackingField;
			}
			[CompilerGenerated]
			[ServerRpc(RunLocally = true)]
			protected set
			{
				_003CCurrentPursuitLevel_003Ek__BackingField = value;
		...
		public EPursuitLevel SyncAccessor__003CCurrentPursuitLevel_003Ek__BackingField
		{
			...
			set
			{
				...
				{
					syncVar____003CCurrentPursuitLevel_003Ek__BackingField.SetValue(value, value != null);
				}
			}
		}
		...
		protected virtual void Update()
		{
			...
			if (SyncAccessor__003CCurrentPursuitLevel_003Ek__BackingField != 0 && SyncAccessor__003CCurrentPursuitLevel_003Ek__BackingField != EPursuitLevel.Lethal)
			{
				UpdateEscalation();
			}
			if (SyncAccessor__003CCurrentPursuitLevel_003Ek__BackingField != 0)
			{
				UpdateTimeout();
				UpdateMusic();
			}
			if (SyncAccessor__003CCurrentPursuitLevel_003Ek__BackingField != 0 && TimeSinceSighted > 2f)
			{
		...
		public void SetPursuitLevel(EPursuitLevel level)
		{
			...
			if (num == EPursuitLevel.None && level != 0)
			{
			...
			if (num != 0 && level == EPursuitLevel.None)
			{
				ClearCrimes();
		...
		{
			syncVar____003CCurrentPursuitLevel_003Ek__BackingField.SetValue(value,  true);
		}
		...
		{
			syncVar____003CLastKnownPosition_003Ek__BackingField.SetValue(value,  true);
		}
		...
		public virtual bool ReadSyncVar___ScheduleOne_002EPlayerScripts_002EPlayerCrimeData(PooledReader PooledReader0, byte UInt321, bool Boolean2)
		{
			switch (UInt321)
			{
			case 1:
			{
				...
				{
					syncVar____003CLastKnownPosition_003Ek__BackingField.SetValue(syncVar____003CLastKnownPosition_003Ek__BackingField.GetValue(calledByUser: true),  true);
					return true;
				}
				Vector3 value2 = PooledReader0.ReadVector3();
				syncVar____003CLastKnownPosition_003Ek__BackingField.SetValue(value2, Boolean2);
				return true;
			}
			case 0:
			{
				if (PooledReader0 == null)
				{
					syncVar____003CCurrentPursuitLevel_003Ek__BackingField.SetValue(syncVar____003CCurrentPursuitLevel_003Ek__BackingField.GetValue(calledByUser: true),  true);
					return true;
				}
				EPursuitLevel value = GeneratedReaders___Internal.Read___ScheduleOne_002EPlayerScripts_002EPlayerCrimeData_002FEPursuitLevelFishNet_002ESerializing_002EGenerateds(PooledReader0);
				syncVar____003CCurrentPursuitLevel_003Ek__BackingField.SetValue(value, Boolean2);
				return true;
			}
			default:
				return false;
